...
def embed_pouvoirs():
    embed = discord.Embed(
        ...
        description=(
            ...
            "• `/fruit marche_noir` (dans #boutique) — voir les fruits encore disponibles (5 000฿ à 75 000฿ selon la rareté).\n"
            "• `/fruit acheter` (dans #boutique) — en acheter et le manger immédiatement.\n"
            ...
            "• `/haki voir` — consulter tes niveaux, utilisable n'importe où.\n"
...
def embed_metiers():
    embed = discord.Embed(
        ...
        description=(
            ...
            "**🏺 Archéologue** → `/archeologue etudier` gagne des Berrys en étudiant des ruines, "
            "`/archeologue dechiffrer` crée des reliques procurant des soins à partir de vestiges anciens.\n\n"
